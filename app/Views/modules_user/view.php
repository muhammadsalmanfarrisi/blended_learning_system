...
<div class="card container-fluid bg-primary text-white py-5" style="background-image: url('<?= base_url('images/bg_modul.jpg'); ?>'); background-size: cover; background-position: center;">
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center flex-column flex-md-row">
            ...
            <a href="<?= site_url('modules_user'); ?>" class="btn btn-danger btn-lg mx-2" style="text-transform: uppercase; padding: 12px 30px; font-size: 1.1rem;">
                Kembali
            </a>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <p>Pretest sudah selesai.</p>
                        <p>Skor Anda: <?= $score ?> / 100</p>
                        <p>Waktu Submit: <?= $submitted_at ?></p>
                    <?php endif; ?>
                </div>
