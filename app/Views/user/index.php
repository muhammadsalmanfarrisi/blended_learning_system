                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="<?= base_url('uploads/foto/' . $user->user_image); ?>" alt="Profile Image" class="img-fluid rounded-circle mb-3" style="max-width: 150px;">
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="text-right mb-3">
                                        <a href="<?= base_url('user/edit/' . user()->id); ?>" class="btn btn-primary">
