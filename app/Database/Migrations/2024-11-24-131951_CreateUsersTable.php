...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'tanggal_lahir'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'agama'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'divisi_kerja'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'jabatan'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'alamat'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'nomor_telepon'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'tingkat_pendidikan_terakhir'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'jurusan_program_studi'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'pengalaman_kerja' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'fullname'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'username'         => ['type' => 'varchar', 'constraint' => 30, 'null' => true],
